...
% Set inner or outer coil Radious
tProbe.Coil.Rout_glob = 90e-3;  % Outer radious of the coil (fixed), not used if tProbe.Coil.emfNear = 1
tProbe.Coil.Rin_glob = (216.00e-3)/2; % 45/2; % not used if tProbe.Coil.emfNear = 0
...
tProbe.Freqs.bw_glob = 0.5e3; % Bandwidth of interest
tProbe.Freqs.f0_glob = 15e3; % Central frequency of interest
