...
function M_0 = M_0_estFast(Bp,Pd)
    % Field strength Bp in Tesla
%     Pd = norm_Pd * 6.7e28; % Pd of water = 6.7e28
    % Other constants
...
%     Bsample = M_0*mu_0;
%     Bsample = 4*pi*1e-7*(ones(size(Bp,1),1)*Pd).*((42.576e6^2)*(6.626e-34^2)*1/2*(1/2+1)*Bp./(3*1.38e-23*310)); % Amperes/meter
%     M_0 = 4.6507e-32*norm_Pd * 6.7e28*Bp; % Amperes/meter
    M_0 = 4.6507e-32*Pd*Bp; % Amperes/meter
end
